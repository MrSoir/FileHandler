...
namespace ListFiles
{
    ...
    QFileInfoList getFoldersInDirectory(const QDir& dir, bool showHiddenFiles = false);
    QFileInfoList getFilesInDirectory(const QDir& dir, bool showHiddenFiles = false);
