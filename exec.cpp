...
{
    return StringOps::trim(exec_Linux("file --mime-type -b " + path)); // -b for brief -> ohne -b wird z.B. folgendes zurueckgegeben: $/home/hippo/Documents/exmpl.pdf: application/pdf
}
